...
#ddf0s = [0, 0.3321, 0.7570, 0.512, 1.2325] # initial value of the second derivative of f
...
for i in range(len(alphas)):
    ...
    print(f"For alpha = {np.around(ddf0s[i],4)}, ddf(0) = {np.around(ddf0s[i],4)}")
